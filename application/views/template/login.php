			...
			<div id="login-form" class="boxform">
				<div class="ui grid nomargin">
					<div class="six wide column divcenter content-form">
						<form method="post" action="<?php echo base_url();?>home/product">
							<div class="aligncenter">
								<img src="<?php echo assets_url;?>img/logo-black.png" alt="Jelajahi Indonesiamu" title="Jelajahi Indonesiamu" class="divcenter" />
								<div class="ui grid nomargin">
				...
				<div class="ui grid nomargin">
					<div class="eight wide column divcenter content-form">
						<div class="ui grid two column" style="position:relative;">
							...
							<div class="ui horizontal divider">Atau</div>
							<div class="column">
								<a href="<?php echo base_url();?>home/product">
    ...
    <script type="text/javascript">
    	$(document).ready(function(){
    		$('#login-reg-page').backstretch([
	            ...
	            "<?php echo assets_url;?>img/landscape/Danau Toba.jpg",
	            "<?php echo assets_url;?>img/landscape/Indonesia-Jakarta-Monas-Adventure-Tour.jpg"
	            ], {
	                fade: 750,
	                duration: 8000
	        });
