...
<?php 
    ...
    echo '<h5 align="center" style="margin-top:240px">Oops... hasil pencarian Anda tidak dapat ditemukan.</h5>';
    echo '<p align="center"><a href="product" class="btn btn-lg btn-default">Kembali Ke Product</a></p>';
}
?>
