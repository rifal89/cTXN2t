<div id="store">
    ...
    <div id="img-store">
        <div class="ui medium circular image logo-store">
            <img src="<?php echo assets_url; ?>img/icon/food.png" />
    ...
    <div id="body-store">
            ...
            <div class="card items-ui">
                ...
                <div class="card-content">
                    <div class="table imgcategory-small">
                        <a class="tocategory table-cell imgcategory" style="background-image: url('<?php echo assets_url; ?>img/product/Dress.jpg');"></a>
                        <a class="tocategory table-cell imgcategory" style="background-image: url('<?php echo assets_url; ?>img/product/batik-keris.jpg');"></a>
                        <a class="tocategory table-cell imgcategory" style="background-image: url('<?php echo assets_url; ?>img/product/bolgul3in1.jpg');"></a>
                    </div>
                </div>
            </div>
            <?php
        ...
        <div id="page_nav">
            <a href="<?php echo base_url(); ?>account/mystore/category-pages/2/index.php"></a>
        </div>
    </div>
</div>
