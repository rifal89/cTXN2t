    ...
    <div id="body-content" class="full column">
        <div id="account-pages">
            <div class="col s12 nopadding">
                <ul class="tabs">
                    <li class="tab col s3">
                        <a class="active" href="account_profile">
                            <i class="mdi-action-account-circle"></i><span class="tab-title">Profil</span>
                        </a>
                    </li>
                    <li class="tab col s3">
                        <a href="account_store">
                            <i class="mdi-action-store"></i><span class="tab-title">Toko Saya</span>
                        </a>
                    </li>
                    <li class="tab col s3">
                        <a href="account_selling">
                            <i class="mdi-editor-attach-money"></i><span class="tab-title">Data Penjualan</span>
                        </a>
                    </li>
                    <li class="tab col s3">
                        <a href="account_buying">
                            <i class="mdi-action-shopping-cart"></i><span class="tab-title">Data Pembelian</span>
                        </a>
                    </li>
                </ul>
            </div>
            <div id="account_profile" class="col s12 nopadding-side tab-content"></div>
            <div id="account_store" class="col s12 nopadding-side tab-content"></div>
            <div id="account_selling" class="col s12 nopadding-side tab-content"></div>
            <div id="account_buying" class="col s12 nopadding-side tab-content"></div>
        </div>
    </div>
</div>
...
function dropzoneImg(){
    if($.cookie('hasLogin') == "true"){
        $(".upload-file").dropzone({
            url: "<?php echo assets_url;?>upload",
...
function addCategoryPages(){
    $('#addCategory').click(function(){
        $.ajax({
            url: "<?php echo base_url();?>home/" + "account_store_category",
            success: function(data){
                $('#account-pages #account_store').html(data);
...
function addProduct(){
    $('#addProduct').click(function(){
        $.ajax({
            url: "<?php echo base_url();?>home/" + "account_store_product",
            success: function(data){
...
function toCategoryInMyStore(){
    $('.tocategory').click(function(){
        $.ajax({
            url: "<?php echo base_url();?>home/" + "account_store_category_detail",
            success: function(data){
                $('#account-pages #account_store').html(data);
                isoLayout();
                addCategoryProduct();
...
function backToMyStore(){
    $('#backToMyStore').click(function(){
        $.ajax({
            url: "<?php echo base_url();?>home/" + "account_store",
            success: function(data){
...
function accountPages(){
    $.ajax({
        url: "<?php echo base_url();?>home/" + "account_profile",
        success: function(data){
            $('#account-pages #account_profile').html(data);
            isoLayout();
            dropzoneImg();
        }
    });
    ...
    $('#account-pages .tabs li a').click(function(){
        ...
        var resThisHref = thisHref;
        $.ajax({
            url: "<?php echo base_url();?>home/" + resThisHref,
            success: function(data){
