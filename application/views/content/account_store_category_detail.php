    ...
    <div id="body-store">
            ...
            <div class="ui segment nopadding">
                ...
                <div class="ui grid table nomargin small-desc-store">
                    <div class="table-cell">
                        <a onclick="javascript::back();" class="waves-effect waves-light">
        ...
        <div id="list-item">
            ...
            <div class="card items-ui">
                <div class="card-image">
                    <a href="detail-product">
                        <img src="<?php echo assets_url; ?>img/product/batik-keris.jpg" class="activator" />
                    </a>
                </div>
                <div class="card-content">            
            ...
            <div class="card items-ui">
                <div class="card-image">
                    <a href="detail-product">
                        <img src="<?php echo assets_url; ?>img/product/bolgul3in1.jpg" class="activator" />
                    </a>
                </div>
                <div class="card-content">
            ...
            <div class="card items-ui">
                <div class="card-image">
                    <a href="detail-product">
                        <img src="<?php echo assets_url; ?>img/product/kaos.jpg" class="activator" />
                    </a>
                </div>
                <div class="card-content">
            ...
            <div class="card items-ui">
                <div class="card-image">
                    <a href="detail-product">
                        <img src="<?php echo assets_url; ?>img/product/6.jpg" class="activator" />
                    </a>
                </div>
                <div class="card-content">               
            ...
            <div class="card items-ui">
                <div class="card-image">
                    <a href="detail-product">
                        <img src="<?php echo assets_url; ?>img/product/3.jpg" class="activator" />
                    </a>
                </div>
                <div class="card-content">
            ...
            <div class="card items-ui">
                <div class="card-image">
                    <a href="detail-product">
                        <img src="<?php echo assets_url; ?>img/product/1.jpg" class="activator" />
                    </a>
                </div>
                <div class="card-content">
        ...
        <div id="page_nav">
            <a href="<?php echo base_url(); ?>store/product/pages/2/index.php"></a>
        </div>
    </div>
</div>