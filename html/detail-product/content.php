    ...
    <div id="body-content" class="full column">
        <div class="ui grid stackable two column nomargin">
            <div class="column">
                <div id="product-image" class="royalSlider rsDefault">
                    <?php
                        ...
                        while($i <= 6){
                    ?>
                    <a class="rsImg bugaga" data-rsw="400" data-rsh="500"  data-rsBigImg="<?php echo $base; ?>assets/img/product/<?php echo $i; ?>.jpg" href="assets/img/product/<?php echo $i; ?>.jpg">
                        <img width="96" height="72" class="rsTmb" src="assets/img/product/thumb/<?php echo $i; ?>.jpg" />
                    </a>
                    <?php
                        $i++; }
                    ?>
            ...
            <div class="column alignjustify">
                ...
                <form id="addToCartForm" method="post" action="<?php echo $base; ?>checkout">
                ...
                <div class="row">
                    ...
                    <div id="review-produk" class="col s12 nopadding-side">
                        ...
                        <div class="ui comments">
                            ...
                            <div class="comment">
                                <a class="avatar">
                                    <img src="assets/img/avatar/matt.jpg">
                                </a>
                                <div class="content">
                            ...
                            <div class="comment">
                                <a class="avatar">
                                    <img src="assets/img/avatar/elliot.jpg">
                                </a>
                                <div class="content">
                    ...
                    <div id="diskusi-produk" class="col s12 nopadding-side">
                        <div class="ui comments">
                            ...
                            <div class="comment">
                                <a class="avatar">
                                    <img src="assets/img/avatar/jenny.jpg">
                                </a>
                                <div class="content">
                                ...
                                <div class="comments">
                                    <div class="comment">
                                        <a class="avatar">
                                            <img src="assets/img/avatar/joe.jpg">
                                        </a>
                                        <div class="content">
