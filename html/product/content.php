<div id="list-item">
    <div class="card items-ui">
        <div class="card-image">
            ...
            <a href="store" class="card-store" title="Toko Maichi" data-step="2" data-intro="Klik Logo Penjual jika ingin melihat detail penjual.">
                <img src="assets/img/store/store1.jpg" class="store-logo" />
            </a>
        </div>
        <div class="card-content">
            <span class="card-title activator grey-text text-darken-4"><a href="detail-product">Kripik Maichi</a> <i class="mdi-navigation-more-vert right" data-step="3" data-intro="Klik disini untuk melihat deskripsi singkat produk."></i></span>
        ...
        <div class="card-action">                
            <button class="btn waves-effect waves-light" onclick="window.location.href='<?php echo $base; ?>detail-product'" data-step="1" data-intro="Klik Order untuk pemesanan barang ini.">
    ...
    <div class="card items-ui">
        <div class="card-image">
            ...
            <a href="store" class="card-store" title="Toko Dress">
                <img src="assets/img/store/store2.jpg" class="store-logo" />
            </a>
        </div>
        <div class="card-content">
    ...
    <div class="card items-ui">
        <div class="card-image">
            ...
            <a href="store" class="card-store" title="Batik Keris">
                <img src="assets/img/store/store3.jpg" class="store-logo" />
            </a>
        </div>
        <div class="card-content">            
    ...
    <div class="card items-ui">
        <div class="card-image">
            ...
            <a href="store" class="card-store" title="Bolu Meranti">
                <img src="assets/img/store/store4.jpg" class="store-logo" />
            </a>
        </div>
        <div class="card-content">
    ...
    <div class="card items-ui">
        <div class="card-image">
            ...
            <a href="store" class="card-store" title="T-Shirt Store">
                <img src="assets/img/store/store1.jpg" class="store-logo" />
            </a>
        </div>
        <div class="card-content">
    ...
    <div class="card items-ui">
        <div class="card-image">
            ...
            <a href="store" class="card-store" title="Toko Anting">
                <img src="assets/img/store/store2.jpg" class="store-logo" />
            </a>
        </div>
        <div class="card-content">               
    ...
    <div class="card items-ui">
        <div class="card-image">
            ...
            <a href="store" class="card-store" title="Toko Tas">
                <img src="assets/img/store/store3.jpg" class="store-logo" />
            </a>
        </div>
        <div class="card-content">
    ...
    <div class="card items-ui">
        <div class="card-image">
            ...
            <a href="store" class="card-store" title="Toko Sepatu">
                <img src="assets/img/store/store4.jpg" class="store-logo" />
            </a>
        </div>
        <div class="card-content">
